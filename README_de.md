...
npm install
npm start
# http://localhost:7443 im Browser öffnen
```
...
> **Hinweis**: Luma Studio ist jetzt eine reine Desktop-App; der gesamte Quellcode liegt im Branch `main`.
...
├── storage/                # Laufzeitdaten (userData)
├── test/                   # Regressionstests (node:test)
└── package.json
```
