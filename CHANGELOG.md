...
### Release Assets
- `Luma Studio BAT 1.0.4.zip` — Windows bat-script edition (online), packaged as a zip for release distribution

### Notes
- This release focuses on comprehensive logging system stability improvements.
